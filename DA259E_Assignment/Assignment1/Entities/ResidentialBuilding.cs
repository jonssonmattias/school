...
{
    public abstract class ResidentialBuilding : Estate
    {
        public ResidentialBuilding(int id, Categories category, string type, LegalForms legalForm, Address address, Image image, string imagename)
